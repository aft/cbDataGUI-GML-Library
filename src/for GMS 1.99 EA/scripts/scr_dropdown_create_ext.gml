/// scr_dropdown_create_ext(x, y, width, height, font_button, font_list, blend_color, list_as_array_or_dsmap, [optional:initial_value]);
/**
...
scr_dropdown_set_font(o, argument[4], argument[5]);
o.blend_color = argument[6];
scr_dropdown_set_list(o, argument[7]);
if (argument_count == 9) scr_dropdown_set_value(o, argument[8]);
return o;
